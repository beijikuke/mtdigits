define(['jquery', 'bootstrap', 'frontend', 'table', 'form', 'template', 'echarts', 'echarts-theme'], function ($, undefined, Frontend, Table, Form, Template, Echarts) {
    ...
    var Controller = {
        ...
        aggregate:function (){
            ...
            $.post('/user/dashboard/index',{'datetime':datetime,'merchant_site_url':merchant_site_url},function (res){
                if(res.code===1){
            ...
            $.post('/user/dashboard/orderDateRangeEchart',{'datetime':datetime,'merchant_site_url':merchant_site_url},function (res){
                if(res.code===1){
            ...
            $.post('/user/dashboard/paymentMethodEchart',{'datetime':datetime,'merchant_site_url':merchant_site_url},function (res){
                if(res.code===1){
