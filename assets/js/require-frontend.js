require.config({
    ...
    include: ['css', 'layer', 'toastr', 'fast', 'frontend', 'frontend-init', 'table', 'form', 'dragsort', 'addtabs', 'selectpage', 'bootstrap-daterangepicker'],
    paths: {
        'lang': "empty:",
        'form': 'require-form',
        'table': 'require-table',
    ...
    baseUrl: requirejs.s.contexts._.config.config.site.__CDN__ + '/assets/js/', //资源基础路径
    map: {
        '*': {
...
require(['jquery', 'bootstrap'], function ($, undefined) {
    ...
    $(function () {
        require(['fast'], function (Fast) {
            require(['frontend', 'frontend-init', 'addons'], function (Frontend, undefined, Addons) {
                //加载相应模块
                if (Config.jsname) {
